...
-- regex : password valide doit comprendre huit caractères, au minimum une majuscule, une lettre minuscule, un chiffre et un caractère spécial.
CREATE DOMAIN "valid_pass" AS TEXT
CHECK(
